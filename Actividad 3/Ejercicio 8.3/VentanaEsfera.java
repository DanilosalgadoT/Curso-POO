...
public class VentanaEsfera extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger =
        java.util.logging.Logger.getLogger(VentanaEsfera.class.getName());
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(labelRadio, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            resultadoVolumen.setText("Volumen (cm3): " + String.format("%.2f", esfera.calcularVolumen()));
            resultadoSuperficie.setText("Superficie (cm2): " + String.format("%.2f", esfera.calcularSuperficie()));
        } catch (Exception e) {
            error = true;
        } finally {
            if (error) {
